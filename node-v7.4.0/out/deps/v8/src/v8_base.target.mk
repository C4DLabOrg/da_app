...
quiet_cmd__home_micha_sisitech_AppOosc_ionic2app_node_v7_4_0_deps_v8_src_v8_gyp_v8_base_target_run_mkpeephole = ACTION _home_micha_sisitech_AppOosc_ionic2app_node_v7_4_0_deps_v8_src_v8_gyp_v8_base_target_run_mkpeephole $@
cmd__home_micha_sisitech_AppOosc_ionic2app_node_v7_4_0_deps_v8_src_v8_gyp_v8_base_target_run_mkpeephole = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps/v8/src; mkdir -p $(obj).$(TOOLSET)/v8_base/geni; "$(builddir)/mkpeephole" "$(obj).$(TOOLSET)/v8_base/geni/bytecode-peephole-table.cc"
...
$(obj).$(TOOLSET)/$(TARGET)/geni/bytecode-peephole-table.cc: $(builddir)/mkpeephole FORCE_DO_CMD
	$(call do_cmd,_home_micha_sisitech_AppOosc_ionic2app_node_v7_4_0_deps_v8_src_v8_gyp_v8_base_target_run_mkpeephole)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/bytecode-peephole-table.cc
action__home_micha_sisitech_AppOosc_ionic2app_node_v7_4_0_deps_v8_src_v8_gyp_v8_base_target_run_mkpeephole_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/bytecode-peephole-table.cc
...
$(OBJS): | $(action__home_micha_sisitech_AppOosc_ionic2app_node_v7_4_0_deps_v8_src_v8_gyp_v8_base_target_run_mkpeephole_outputs)
...
$(obj).target/deps/v8/src/libv8_base.a: | $(action__home_micha_sisitech_AppOosc_ionic2app_node_v7_4_0_deps_v8_src_v8_gyp_v8_base_target_run_mkpeephole_outputs)

# Preserve order dependency of special output on deps.
$(action__home_micha_sisitech_AppOosc_ionic2app_node_v7_4_0_deps_v8_src_v8_gyp_v8_base_target_run_mkpeephole_outputs): | $(builddir)/mkpeephole $(obj).target/tools/icu/icuuc.stamp
